<template>
	<a class="text-white cursor-pointer hover:text-gray-700 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" @click="open = true">Terms</a>
			...
			<div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
				...
				>
					...
					<span class="sr-only">Close modal</span>
							...
							<div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 overflow-y-scroll h-96">
									<p class="text-base leading-relaxed">
										Last updated: August 06, 2022 Please read these terms and conditions carefully before using Our Service.
									...
									<h4>Definitions</h4>
									<p class="text-base leading-relaxed">For the purposes of these Terms and Conditions:</p>
									<p class="text-base leading-relaxed">
									...
									<p class="text-base leading-relaxed">Country refers to: Washington, United States</p>
									<p class="text-base leading-relaxed">
										Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to No To Pests.
									</p>

									<p class="text-base leading-relaxed">
										Device means any device that can access the Service such as a computer, a cellphone or a digital tablet
									</p>
									<p class="text-base leading-relaxed">Service. refers to the Website</p>
									<p class="text-base leading-relaxed">
										...
										created with the help of the TermsFeed Terms and Conditions Generator.
									</p>
									...
									<p class="text-base leading-relaxed">Website refers to No To Pests, accessible from notopests.com</p>
									<p class="text-base leading-relaxed">
									...
									<p class="text-base leading-relaxed">
										...
										Service.
									</p><h4>Links to Other Websites</h4>
									<p class="text-base leading-relaxed">
									...
									<p class="text-base leading-relaxed">Upon termination, Your right to use the Service will cease immediately.</p>
									...
									<p class="text-base leading-relaxed">
										...
										in which you are resident in. United States Legal Compliance You represent and warrant that (i) You are not
										located in a country that is subject to the United States government embargo, or that has been designated by
										the United States government as a “terrorist supporting” country, and (ii) You are not listed on any United
										States government list of prohibited or restricted parties.
									</p>
									<p class="text-base leading-relaxed">Severability and Waiver</p>
									<h4>Severability</h4>
									<p class="text-base leading-relaxed">
									...
									<h4>Contact Us</h4>
									<p class="text-base leading-relaxed">
										If you have any questions about these Terms and Conditions, You can contact us: By email: info@notopests.com
									</p>
							</div>
